...
classdef Arch6VisionProcessor < Neuron
    ...
    methods
       function obj = Arch6VisionProcessor() 
           obj = obj@Neuron();         
           obj.weights  = [0., -0.269, 0.8923, 0.0422];
           obj.cweights = [0., -0.269, 0.8923, 0.8422];
       end
       ...
       % original learning that generated the weights
